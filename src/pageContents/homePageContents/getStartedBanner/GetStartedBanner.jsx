  ...
  return (
    <div className=' bg-white flex flex-col h-full justify-center p-10 mx-auto'>
        ...
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl w-[80%]'>1,200+</h1> <p className='text-sm font-prompt w-[80%]'>Mobile apps built for diverse industries</p>
        </motion.div>
        ...
        viewport={{ once: true, amount: 0.3 }}  
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl w-[80%]'>$500M+</h1> <p className='text-sm font-prompt w-[80%]'>Raised by clients through funding rounds</p>
        </motion.div>
        ...
        viewport={{ once: true, amount: 0.3 }}  
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl w-[80%]'>12M+</h1> <p className='text-sm font-prompt w-[80%]'>Mobile apps built for diverse industries</p>
        </motion.div>
        ...
        viewport={{ once: true, amount: 0.3 }}  
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl w-[80%]'>50+</h1> <p className='text-sm font-prompt w-[80%]'>5-Star Reviews on Clutch for Mobile App Development Services</p>
        </motion.div>
        </div>
