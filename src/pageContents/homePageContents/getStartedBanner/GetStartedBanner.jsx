  ...
  return (
    <div className=' bg-white flex flex-col h-full justify-center p-10 mx-auto'>
        ...
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl'>1,200+</h1> <p className='text-sm font-prompt'>Mobile apps built for diverse industries</p>
        </motion.div>
        ...
        viewport={{ once: true, amount: 0.3 }}  
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl'>$500M+</h1> <p className='text-sm font-prompt'>Raised by clients through funding rounds</p>
        </motion.div>
        ...
        viewport={{ once: true, amount: 0.3 }}  
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl'>12M+</h1> <p className='text-sm font-prompt'>Mobile apps built for diverse industries</p>
        </motion.div>
        ...
        viewport={{ once: true, amount: 0.3 }}  
        className='flex-col justify-center text-center mx-auto text-red-700 font-serif font-semibold '>
          <h1 className='text-4xl'>50+</h1> <p className='text-sm font-prompt'>5-Star Reviews on Clutch for Mobile App Development Services</p>
        </motion.div>
        </div>
