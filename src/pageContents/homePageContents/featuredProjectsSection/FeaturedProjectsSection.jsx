...
const FeaturedProjectSection = () => {
  ...
  return (
    <div className='fp-main h-full pt-20 pb-2 px-5 mb-auto mx-auto justify-center items-center'>
      ...
      >
        <h1 className='text-4xl sm:text-6xl lg:text-6xl w-[80%]'>Leading Mobile App Development Company <span className='text-red-700'>Building Success Stories</span> for Ambitious Entrepreneurs</h1>
      </motion.div>
